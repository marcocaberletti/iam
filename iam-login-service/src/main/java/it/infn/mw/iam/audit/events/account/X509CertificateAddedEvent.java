...
public class X509CertificateAddedEvent extends AccountUpdatedEvent {

  private static final long serialVersionUID = -4714077026960101784L;
  ...
  public X509CertificateAddedEvent(Object source, IamAccount account,
    ...
    super(source, account, ACCOUNT_ADD_X509_CERTIFICATE,
        buildMessage(ACCOUNT_ADD_X509_CERTIFICATE, x509certificates));
